...
function Zkboredapes() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_Zkboredapes.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://pbs.twimg.com/profile_images/1529647370128203777/cmBrk9sI_400x400.jpg"
                    }
                    collectionId={5}
                    name="Zkboredapes"
                    twitter="https://twitter.com/zkboredapes"
                    discord="https://discord.gg/njnMEMtDtj"
                />
                <Statistic contractAddress="0xac0402f2927c3864d9ae070793dc478a868c9573" />
