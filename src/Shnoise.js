...
function Shnoise() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get("json/metadata_rank_shnoise.json");
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://arweave.net/_88Rwbp9ydEYqFz-k7EPf-ww2iGISWgnnjXeY-NPl1c/example.png"
                    }
                    collectionId={12}
                    name="Shnoises"
                    twitter="https://twitter.com/Shnoises"
                    discord="https://discord.gg/Ud9ncJHnEH"
                />
