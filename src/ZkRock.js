...
function Zkrock() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get("json/metadata_rank_zkRock.json");
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://omnisea.infura-ipfs.io/ipfs/QmeQfeJ67NnFqAQkzP1aZtt1Ys2wQySRpNkmZMyBW2rjdc"
                    }
                    collectionId={9}
                    name="ZkRock"
                    twitter="https://twitter.com/ZksyncRock"
                    discord="https://discord.gg/ZksyncRock"
                />
                <Statistic contractAddress="0x14ebc324aee195593b00e58ca06917ba40294285" />
