...
function Otterlabs() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_Otterlabs.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://static.souffl3.com/sui-token-image/0xd7cf7dac594779cd00bf14527e4355fda3cfffc34c07b1ca517dfd4f93764bcf-2213369.png"
                    }
                    collectionId={15}
                    name="Otter Labs"
                    twitter="https://twitter.com/OtterLabsNFT"
                    discord="https://discord.gg/otterlabs"
                />
