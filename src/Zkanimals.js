...
function Zkanimals() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get("json/metadata_rank_zkAnimals.json");
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://mintsquare.sfo3.cdn.digitaloceanspaces.com/mintsquare%2Fcollections%2Fzkanimals.jpeg"
                    }
                    collectionId={11}
                    name="ZkAnimals"
                    twitter="https://twitter.com/ZkAnimals"
                    discord="https://discord.gg/"
                />
                <Statistic contractAddress="0x3524452c8ffb81f11b066ad9a991005cc42587bc" />
