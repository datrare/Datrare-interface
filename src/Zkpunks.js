...
function Zkpunks() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get("json/metadata_rank_Zkpunks.json");
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://punkszk.com/punk.png"
                    }
                    collectionId={4}
                    name="Zkpunks"
                    twitter="https://twitter.com/punksZK"
                    discord="https://discord.gg/zkpunks"
                />
                <Statistic contractAddress="0xcb5d99e8b5d626f882e1fb4067d37759d67595a6" />
