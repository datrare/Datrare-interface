...
function Zkboys() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get("json/metadata_rank_zkBoys.json");
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://mintsquare.sfo3.cdn.digitaloceanspaces.com/mintsquare%2Fcollections%2Fzkboys.png"
                    }
                    collectionId={10}
                    name="zkBoys"
                    twitter="https://twitter.com/zkBoysNFT"
                    discord="https://discord.gg/zkBoysNFT"
                />
                <Statistic contractAddress="0x7ee3b7b4aaecdff64d1a3824c0b79f6e74459747" />
