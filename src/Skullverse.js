...
function Skullverse() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_Skullverse.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://mintsquare.sfo3.cdn.digitaloceanspaces.com/mintsquare%2Fcollections%2Fskullverse.jpeg"
                    }
                    collectionId={6}
                    name="Skullverse"
                    twitter="https://twitter.com/skullverseNFT"
                    discord="https://discord.gg/EnyFfXrxgq"
                />
                <Statistic contractAddress="0x2cb68206d8f3cab47bfb38bd2b703738f2d59b94" />
