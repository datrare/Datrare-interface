...
function Mutantcore() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_Mutantcore.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={"/images/mutantcore.png"}
                    collectionId={1}
                    name="Mutant Ape Yacht Core"
                    twitter="https://twitter.com/MutantApeCore"
                    discord="https://discord.gg/US5nAsC2KR"
