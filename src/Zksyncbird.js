...
function Zksyncbird() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_zksyncbird.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://pbs.twimg.com/profile_images/1641375478031486976/gBphHgc5_400x400.jpg"
                    }
                    collectionId={7}
                    name="Zksync Birds"
                    twitter="https://twitter.com/zkSyncBirds"
                    discord="https://discord.gg/zksyncbird"
                />
                <Statistic contractAddress="0x9057c41ff7f1399f25bae05450403675d51d64c5" />
