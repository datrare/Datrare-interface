...
function Thesyncers() {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            ...
            // );
            const response = await axios.get(
                "json/metadata_rank_Thesyncers.json"
            );
        ...
        <>
            ...
            >
                <CollectionHeader
                    ...
                    imgSrc={
                        "https://i.imgur.com/gJsuRDt.jpg"
                    }
                    collectionId={13}
                    name="The Syncers"
                    twitter="https://twitter.com/TheSyncers"
                    discord="https://discord.com/invite/wQyW67ew"
                />
                <Statistic contractAddress="0x40e3d8ebf601f1aa71dacffbea57abe696a61964" />
